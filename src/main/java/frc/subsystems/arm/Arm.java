...
public class Arm extends SubsystemBase {
    ...
    @Getter
    private double goalInDegrees = ArmConstants.potentiometerMinAngle;
        ...
        DashboardManager.getInstance()
                .addCommand(
                        ...
                        new InstantCommand(
                                ...
                                this),
                        LayoutConstants.CoastCommand);
        DashboardManager.getInstance()
                .addBoolSupplier(true, "Limit Switch", () -> inputs.limitSwitch, LayoutConstants.LimitSwitch);
    }
    ...
    /**
     * Sets the goal of the arm in degrees. Does NOT account for the goal being a value outside of the
     * minimum or maximum degrees.
     *
