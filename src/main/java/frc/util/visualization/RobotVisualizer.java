...
public class RobotVisualizer {
    ...
    private static Transform3d intookNoteOffset =
            new Transform3d(new Translation3d(0.625, 0, 0.02), new Rotation3d(0, Units.degreesToRadians(235), 0));

    @Getter
    private static Transform3d currentArmPose3d = new Transform3d();

    @Getter
    private static Pose3d currentNotePose3d = new Pose3d();
    ...
    public static void update(double angle, double goal) {
        ...
        // Arm Goal
        Pose3d poseGoal = new Pose3d(armTranslation3d, new Rotation3d(0, -Units.degreesToRadians(goal), 0));
        ...
        if (currentNote != null) {
            Pose3d armPosition =
                    robotPosition.plus(new Transform3d(poseAngle.getTranslation(), poseAngle.getRotation()));
