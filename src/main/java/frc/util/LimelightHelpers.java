...
public class LimelightHelpers {
    private static Alert badLLURL = new Alert("Bad LimeLight URL", AlertType.WARNING);
    private static Alert badPoseData = new Alert("Bad Pose Data", AlertType.WARNING);
    private static Alert badLLRequest = new Alert("Bad LimeLight Request", AlertType.WARNING);
    ...
    public static Pose3d toPose3D(double[] inData) {
        badPoseData.set(false);
        if (inData.length < 6) {
            badPoseData.set(true);
            badPoseData.setText("Bad LL 3D Pose Data");
            return new Pose3d();
        }
        return new Pose3d(
    ...
    public static Pose2d toPose2D(double[] inData) {
        ...
        if (inData.length < 6) {
            badPoseData.set(false);
            badPoseData.setText("Bad LL 2d Pose Data");
            return new Pose2d();
        }
    ...
    public static URL getLimelightURLString(String tableName, String request) {
        ...
        try {
            ...
            badLLURL.set(true);
            badLLURL.setText("Bad LimeLight request: " + request);
        }
        return null;
    }
    /////
    ...
    private static boolean SYNCH_TAKESNAPSHOT(String tableName, String snapshotName) {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                badLLRequest.set(true);
                badLLRequest.setText("Bad LL Request, code: " + responseCode);
            }
        } catch (IOException e) {
            badLLRequest.set(true);
            badLLRequest.setText("Bad LL Request, IOException");
        }
        return false;
    }
